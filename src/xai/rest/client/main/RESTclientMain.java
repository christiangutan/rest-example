...
public class RESTclientMain {
	...
	public static void main(String[] args) throws Exception {
		...
		float rad = 6.1f;
		float alt = 2.3f;
		System.out.println("surfaceBase: " + rs.surfaceBase(IP_SERVIDOR, PORT_SERVIDOR, rad));
		System.out.println("surfaceSide: " + rs.surfaceSide(IP_SERVIDOR, PORT_SERVIDOR, rad, alt));
		System.out.println("surfaceTotal: " + rs.surfaceTotal(IP_SERVIDOR, PORT_SERVIDOR, rad, alt));
	}
}